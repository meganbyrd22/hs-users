...
return (
    <div className="flex justify-center items-center h-screen">
        <div className= "flex flex-col fixed justify-center items-center inset-0 bg-black bg-opacity-50">
                <form onSubmit={handleSubmit} className=" border-4 border-emerald-100 rounded-lg p-2 bg-white text-xxl flex flex-col">
                    <h1 className="font-bold text-3xl p-2">Edit User</h1>
                    <div className="grid grid-cols-1 gap-3">
                        <div className="flex">
                            <label className="m-2">
                                First Name: 
                                <input className="border-2 rounded-lg text-sm m-2 p-2 w-60 italic"
                                    type="text" 
                                    name="firstName" 
                            ...
                            <label className="m-2">
                                Last Name: 
                                <input className="border-2 rounded-lg text-sm p-2 m-2 w-60  italic"
                                    type="text" 
                                    name="lastName" 
                        ...
                        <label className="m-2">
                            Email: 
                            <input className="border-2 rounded-lg text-sm ml-12 p-2 w-60 italic"
                                type="text" 
                                name="email" 
                        ...
                        <div className="w-full h-6 bg-violet-100 rounded-lg"></div>
                ...
                <div className="flex flex-col items-center">
                    <button className="mt-12 p-2 border-none bg-orange-200 rounded-full font-bold text-sm w-24 hover:bg-emerald-100"type="submit">Submit</button>
                    <button className="mt-6 p-2 border-none bg-orange-200 rounded-full font-bold text-xs w-16 hover:bg-emerald-100"type="button" onClick={onClose}>Close</button>
                </div>
